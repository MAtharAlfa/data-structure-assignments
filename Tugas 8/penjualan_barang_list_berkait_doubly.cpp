...
void destroyList(List& first) {
    ...
    Pointer pHelp = first, pHapus = nullptr;
...
Pointer deleteAfter(List& first, Pointer& pSearch) {
    ...
    {
        pHapus = nullptr;
        std::cerr << "Tidak ada barang setelah ini! Tidak ada yang dihapus.\n\n";
        return nullptr;
    } else
    {
        pHapus = pSearch->next;
